...
{
\paper{
Xiao, Zhisheng, Karsten Kreis, and Arash Vahdat. "Tackling the generative learning trilemma with denoising diffusion GANs." arXiv preprint arXiv:2112.07804 (2021).
}

\begin{frame}{Generative learning trilemma}{}
      \begin{figure}
        \centering
        \includegraphics[width=1.0\textwidth]{generative-learning-trilemma/outputs/drawing-v00}
        % \caption{The sonographer-probe-patient control system}
      \end{figure}
\end{frame}
}
